...
export const GENERATED_BASE_CONFIG_SCHEMA = {
  ...
  uiHints: {
    ...
    "acp.dispatch.nonThreadedCompletionToParent": {
      label: "ACP Run Completion To Parent (Opt-In)",
      help: 'Opt-in relay for non-threaded ACP mode="run" completions. Set true to send progress/final status back to the parent chat when the requester has a valid external delivery route; leave unset/false to keep the child run isolated unless streamTo="parent" is used.',
      tags: ["advanced"],
    },
    "acp.backend": {
      label: "ACP Backend",
  ...
  version: "2026.3.28-beta.1-dewgie.1",
